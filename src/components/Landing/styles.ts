export const landingStyles = {
  ...
  ctaSecondary: 'border-rule-solid bg-white text-ink hover:border-ink',
  note: 'mt-4 text-[12px] text-soft',
  stage: 'rounded-xl border border-rule-solid bg-white p-4 shadow-[0_1px_0_var(--color-rule)]',
  ...
  card: 'rounded-lg border border-rule-solid bg-white p-5',
